...
// SPI chip-select pin for the Arducam
const int MEGA_CS = PE_7;
...
void setup()
{
    ...
    myUart.send_data_pack(7, "Hello Arduino STM32F429!");
    myCAM.begin();
